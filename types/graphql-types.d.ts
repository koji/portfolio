...
export type FileFieldsEnum = 
  ...
  | 'childrenOssYaml___parent___parent___id'
  | 'childrenOssYaml___parent___parent___children'
  | 'childrenOssYaml___parent___children'
  | 'childrenOssYaml___parent___children___id'
  | 'childrenOssYaml___parent___children___children'
  | 'childrenOssYaml___parent___internal___content'
  | 'childrenOssYaml___parent___internal___contentDigest'
  | 'childrenOssYaml___parent___internal___description'
  | 'childrenOssYaml___parent___internal___fieldOwners'
  | 'childrenOssYaml___parent___internal___ignoreType'
  | 'childrenOssYaml___parent___internal___mediaType'
  | 'childrenOssYaml___parent___internal___owner'
  | 'childrenOssYaml___parent___internal___type'
  | 'childrenOssYaml___children'
  | 'childrenOssYaml___children___id'
  | 'childrenOssYaml___children___parent___id'
  | 'childrenOssYaml___children___parent___children'
  | 'childrenOssYaml___children___children'
  | 'childrenOssYaml___children___children___id'
  | 'childrenOssYaml___children___children___children'
  | 'childrenOssYaml___children___internal___content'
  | 'childrenOssYaml___children___internal___contentDigest'
  | 'childrenOssYaml___children___internal___description'
  | 'childrenOssYaml___children___internal___fieldOwners'
  | 'childrenOssYaml___children___internal___ignoreType'
  | 'childrenOssYaml___children___internal___mediaType'
  | 'childrenOssYaml___children___internal___owner'
  | 'childrenOssYaml___children___internal___type'
  | 'childrenOssYaml___internal___content'
  | 'childrenOssYaml___internal___contentDigest'
  | 'childrenOssYaml___internal___description'
  | 'childrenOssYaml___internal___fieldOwners'
  | 'childrenOssYaml___internal___ignoreType'
  | 'childrenOssYaml___internal___mediaType'
  | 'childrenOssYaml___internal___owner'
  | 'childrenOssYaml___internal___type'
...
export type OssYamlConnection = {
  totalCount: Scalars['Int'];
  edges: Array<OssYamlEdge>;
  nodes: Array<OssYaml>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<OssYamlGroupConnection>;
};


export type OssYamlConnectionDistinctArgs = {
  field: OssYamlFieldsEnum;
};


export type OssYamlConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: OssYamlFieldsEnum;
};

export type OssYamlEdge = {
  next?: Maybe<OssYaml>;
  node: OssYaml;
  previous?: Maybe<OssYaml>;
};

export type OssYamlFieldsEnum = 
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
...
export type OssYamlFilterInput = {
  id?: Maybe<StringQueryOperatorInput>;
  parent?: Maybe<NodeFilterInput>;
  children?: Maybe<NodeFilterListInput>;
  internal?: Maybe<InternalFilterInput>;
...
export type OssYamlFilterListInput = {
  elemMatch?: Maybe<OssYamlFilterInput>;
};

export type OssYamlGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<OssYamlEdge>;
  nodes: Array<OssYaml>;
  pageInfo: PageInfo;
...
export type OssYamlSortInput = {
  fields?: Maybe<Array<Maybe<OssYamlFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___alias___src'
...
export type Unnamed_1_Query = { allOssYaml: { edges: Array<{ node: Pick<OssYaml, 'title' | 'description' | 'stack' | 'link' | 'id'> }> } };

export type Unnamed_2_QueryVariables = {};


export type Unnamed_2_Query = { allProjectsYaml: { edges: Array<{ node: Pick<ProjectsYaml, 'title' | 'subtitle' | 'link' | 'id'> }> } };
